...
function App() {
  ...
  // Movie State
  const [newMovieTitle, setMewMovieTitle] = useState("")
  ...
  return (
    <div>
      ...
      <div>
        <input type="text" placeholder="Movie title...." value={newMovieTitle} onChange={(e) => setMewMovieTitle(e.target.value)} />
        <input type="number" placeholder="Release Date...." onChange={(e) => setNewReleaseDate(Number(e.target.value))} />
        <input type="checkbox" name="" id="" checked={isNewMovieOscar} onChange={(e) => setIsNewMovieOscar(e.target.checked)} />
